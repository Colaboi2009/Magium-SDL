...
#include "src/parser/magium_decoder.hpp"
#include "src/ui/button.hpp"
#include "src/ui/magium_stat.hpp"
#include "src/ui/raw_image.hpp"
#include "src/ui/scroller.hpp"
#include "src/ui/ui_scene.hpp"
...
void setupMainMenuScene() {
    ...
    SDL_FRect mainMenuButtonsPos = {g_width / 2.f, g_height * (mainMenuButtonsDistance + mainMenuButtonsPadding),
                                    g_width * mainMenuButtonsWidth, g_height * mainMenuButtonsHeight};
...
void setupStatsMenuScene() {
	...
	std::shared_ptr<int> pAvailablePoints = std::make_shared<int>(0);
