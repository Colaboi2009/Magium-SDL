...
const float MAIN_SAVE_MENU_BUTTON_TOP_X_POS = .1f;
const float MAIN_SAVE_MENU_BUTTON_TOP_Y_POS = .1f;
const float MAIN_SAVE_MENU_BUTTON_WIDTH = .3f;
const float MAIN_SAVE_MENU_BOTTOM_BUTTON_WIDTH = .4f;
const float MAIN_SAVE_MENU_TOP_BUTTON_WIDTH = .3f;
...
SDL_Color COLOR_STAT_CHECK_PASSED{0, 255, 0, 255};
SDL_Color COLOR_STAT_CHECK_FAILED{255, 0, 0, 255};
} // namespace
